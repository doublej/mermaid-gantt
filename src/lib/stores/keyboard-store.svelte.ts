...
export const keyBindings: KeyBinding[] = [
	...
	{ key: 'Tab', modifiers: [], action: 'indentTask', description: 'Indent task', category: 'task' },
	{ key: 'Tab', modifiers: ['shift'], action: 'outdentTask', description: 'Outdent task', category: 'task' },
